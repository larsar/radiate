...
class Radiate:
    ...
    def connect_and_read(self):
        ...
        service = self.wave_device.getServiceByUUID(btle.UUID('b42e1c08-ade7-11e4-89d3-123b93f75cba'))

        measurement = {}
        for ch in service.getCharacteristics():
            name = ch.uuid.getCommonName()
            if name == 'b42e2a68-ade7-11e4-89d3-123b93f75cba':
                raw = ch.read()
                ...
                measurement['pressure'] = data[7]/50.0
                measurement['co2'] = data[8] * 1.0
                measurement['tvoc'] = data[9] * 1.0
